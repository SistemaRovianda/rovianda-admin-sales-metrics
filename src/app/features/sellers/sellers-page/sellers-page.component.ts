...
import { FormatReportDialogComponent } from '../../home/components/format-report-dialog/format-report-dialog.component';
...
import { SellerRouteComponent } from '../components/seller-route/seller-route.component';


@Component({
  selector: 'sellers-page-component',
...
export class SellersPageComponent implements OnInit {
  ...
  openModalRoute(index:number){
    this.dialog.open(SellerRouteComponent,{
      data:{
        sellerName: this.sellers[index].name,
        sellerId: this.sellers[index].uid
      },
